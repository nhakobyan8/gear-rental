...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center bg-gradient-to-b from-background-light via-background to-background-light">
      <div style={{ backgroundImage: `url("/images/home.webp")` }} className="min-h-[600px] w-full flex flex-col items-center bg-center justify-center">
        <div className="flex flex-col bg-black bg-opacity-30 w-full min-h-[600px] items-center justify-center">
          ...
          <div className="mt-10 w-full md:w-auto">
            <Link className="inline-block mt-4 text-lg md:text-xl px-6 py-3 bg-primary text-white rounded-md hover:bg-primary-dark transition-transform duration-300 ease-in-out transform hover:scale-105 shadow-lg focus:outline-none focus:ring-2 focus:ring-primary-light" href="/products">
              Explore Products
            </Link>
          </div>
        </div>
      ...
      <div className="px-3">
        <section className="mt-20 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 text-text-muted">
            {[
              ...
              <div key={index} className="space-y-4 text-center md:text-left bg-background p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
        ...
        <section className="mt-20 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 text-text-muted">
            {[
              { name: 'Microphone A', description: "A top-tier microphone that captures every detail of your sound." },
        ...
        <section className="mt-20 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 text-text-muted">
            {[
              {
                testimonial:
                  '"GearRental provided us with the best equipment for our recording session. Highly recommended!"',
                name: '- Alex',
              },
              {
